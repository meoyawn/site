...
const tools: ReadonlyArray<ListItem> = [
  ...
  {
    name: "organize-md",
    href: "https://github.com/meoyawn/organize-md",
    subtitle: "Post process Markdown and images for good caching",
    svg: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 208 128'%3E%3Cmask id='a'%3E%3Crect width='100%25' height='100%25' fill='%23fff'/%3E%3Cpath d='M30 98V30h20l20 25 20-25h20v68H90V59L70 84 50 59v39zm125 0-30-33h20V30h20v35h20z'/%3E%3C/mask%3E%3Crect width='100%25' height='100%25' mask='url(%23a)' ry='15'/%3E%3C/svg%3E",
  },
]
...
export default function Index() {
  return (
    <main className="prose mx-6 max-w-prose md:mx-auto">
